...
<section id="home">
    <div id="video">
            <video src="/assets/videos/video_fr.mp4" controls></video>
            <button class="button" onclick="document.getElementById('video').style.display = 'none'; document.querySelector('#video video').pause();">fermer</button>
    </div>
    <div class="container">
        <div class="text">
...
<section id="about">
    <div class="container">
        ...
        <div class="text">
            <h1>Je suis ...</h1>
            <p class="animated">Un étudiant rigoureux, indépendant, et créatif qui vous écoute !</p>
        ...
        <div class="cards">
            ...
            <div class="wrapper"><div id="caroussel" class="animated">
                ...
                <div class="card">
                    ...
                    <p>Transformez vos idées en vidéos dynamiques. La créativité en action, des moments immortalisés avec brillance.</p><a href="/services/audiovisual/"><i class='bx bx-right-arrow-alt' ></i></a></div>
        ...
        <div>
            ...
            <form action="/sendMail.php" method="post">
                ...
                <div class="send">
                    ...
                    <button class="button" type="submit">Envoyer message</button>
                </div>
            </form>
        </div>
    </div>
...
<?php
getFooter(["caroussel.js","projects.js","writingFR.js","numbers.js"]);
?>